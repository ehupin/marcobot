"main";_183‍.x([["bittrex",()=>bittrex]]);let axios;_183‍.w("axios",[["default",["axios"],function(v){axios=v}]]);let Market;_183‍.w("../markets.js",[["Market",["Market"],function(v){Market=v}]]);let inspect;_183‍.w("util",[["inspect",["inspect"],function(v){inspect=v}]]);
...
const bittrex = {
    ...
    async fetchMarkets(){
        ...
        // return
        fs.writeFile("./bittrex.json", inspect(apiResult.data.result), ()=>{})
        retur
