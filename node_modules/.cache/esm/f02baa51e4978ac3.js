"main";_e49‍.x([["binance",()=>binance]]);let axios;_e49‍.w("axios",[["default",["axios"],function(v){axios=v}]]);let Market;_e49‍.w("../markets.js",[["Market",["Market"],function(v){Market=v}]]);
...
const binance = {
    ...
    async fetchMarketPrice(market){
        await axios.get(`https://bittrex.com/Api/v2.0/pub/market/GetLatestTick?marketName=${market.urlLabel}&tickInterval=fiveMin`)
                .then(result => {
                    _e49‍.g.console.log(result.data)
