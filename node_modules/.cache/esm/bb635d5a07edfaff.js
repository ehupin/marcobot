...
async function updateDb(){
    ...
    for (let exchangeName of Object.keys(exchangeModules)){
        const markets = await getExchangeMarkets(exchangeName)
        for (let market of markets){
            market = exchangeModules[exchangeModuleName].fetchMarketPrice(market)
            _07e‍.g.console.log(market)
