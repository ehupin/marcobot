...
async function updateDb(){
    ...
    for (let exchangeName of Object.keys(exchangeModules)){
        ...
        _faf‍.g.console.log('==========================',exchangeName)
...
let $ = cheerio.load('https://exchangebit.info/bittrex')
