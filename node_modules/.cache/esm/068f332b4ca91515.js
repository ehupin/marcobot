"main";_4ca‍.x([["clearDatabase",()=>clearDatabase],["createDbNode",()=>createDbNode],["connectDbNodes",()=>connectDbNodes],["connectDb",()=>connectDb]]);let Database,aql;_4ca‍.w("arangojs",[["Database",["Database"],function(v){Database=v}],["aql",["aql"],function(v){aql=v}]]);// import {getNodetypes} from '../common/utils.js'
...
async function updateCollections(){
    ...
    getNodetypes().forEach(async function (nodetype) {
       ...
       async function createDbNode (nodetypeName, nodeData) {
    ...
    return node
       ...
       async function connectDbNodes (collectionName, sourceNode, destNode) {
    ...
    // console
    _4ca‍.g.console.log('\n=====================\n')
    _4ca‍.g.console.log('>>', destNode._id)
