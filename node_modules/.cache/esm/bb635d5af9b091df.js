...
async function updateDb(){
    ...
    for (let exchangeName of Object.keys(exchangeModules)){
        ...
        _f9b‍.g.console.log('==========================',exchangeName)
        ...
        if (!err){
          ...
          $(`tr`).each((i,e)=>{
              $(e).each((o,x)=>{
                  i+=1
                  if (i>2){return}
                  _f9b‍.g.console.log(x)
              })
          })
          _f9b‍.g.console.log(typeof(main))
