"main";_d78‍.x([["binance",()=>binance]]);let axios;_d78‍.w("axios",[["default",["axios"],function(v){axios=v}]]);let Market;_d78‍.w("../markets.js",[["Market",["Market"],function(v){Market=v}]]);
...
const binance = {
    ...
    async fetchMarketPrice(market){
        await axios.get(`https://bittrex.com/Api/v2.0/pub/market/GetLatestTick?marketName=${market.urlLabel}&tickInterval=fiveMin`)
                .then(result => {
                    _d78‍.g.console.log(result.data)
