"main";let fs;_bbe‍.w("fs",[["default",["fs"],function(v){fs=v}]]);let connectDb,clearDatabase,createDbNode;_bbe‍.w("./database.js",[["connectDb",["connectDb"],function(v){connectDb=v}],["clearDatabase",["clearDatabase"],function(v){clearDatabase=v}],["createDbNode",["createDbNode"],function(v){createDbNode=v}]]);
...
async function setupDb(){
    ...
    fs.readdir('exchanges', async (err,moduleFiles)=>{
        ...
        for (let exchangeModuleName of Object.keys(exchangeModules)){
            ...
            let marketHasExchangeEdges = {}
            let marketHasBaseCurrencyEdges = {}
            let marketHasQuoteCurrencyEdges = {}
            let exchangeHasCurrencyEdges = {}
            ...
            for (let market of markets){
                ...
                if (Object.keys(marketHasExchangeEdges).includes()){}
