...
async function updateDb(){
    ...
    for (let exchangeName of Object.keys(exchangeModules)){
        ...
        _6ec‍.g.console.log('==========================',exchangeName)
...
request('https://exchangebit.info/bittrex', function(err, resp, html) {
        if (!err){
          ...
          $(`tr`).each((i,e)=>{
              $(e).each((o,x)=>{
                  _6ec‍.g.console.log(o,x.name)
              })
          })
          _6ec‍.g.console.log(typeof(main))
