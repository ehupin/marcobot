"main";_bed‍.x([["bittrex",()=>bittrex]]);let axios;_bed‍.w("axios",[["default",["axios"],function(v){axios=v}]]);let Market;_bed‍.w("../markets.js",[["Market",["Market"],function(v){Market=v}]]);
...
const bittrex = {
    ...
    async fetchMarkets(){
        ...
        fs.writeFile("bittrex.json", JSON.stringify(apiResult, null, 4))
