"main";_121‍.x([["bittrex",()=>bittrex]]);let axios;_121‍.w("axios",[["default",["axios"],function(v){axios=v}]]);let Market;_121‍.w("../markets.js",[["Market",["Market"],function(v){Market=v}]]);let inspect;_121‍.w("util",[["inspect",["inspect"],function(v){inspect=v}]]);
...
const bittrex = {
    ...
    async fetchMarkets(){
        ...
        _121‍.g.console.log(inspect(apiResult))
        return
