...
function TempEdgesTree(){
    ...
    return {
        add(type, from, to){
            ...
            if (!Object.keys(edgeTree).includes(from._id)){
                _4fc‍.g.console.log(1)
                edgeTree[type][from._id] = [to._id]
            }
            else {
                _4fc‍.g.console.log(2)
