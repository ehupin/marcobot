"main";_ef3‍.x([["clearDatabase",()=>clearDatabase],["createDbNode",()=>createDbNode],["connectDbNodes",()=>connectDbNodes],["setMarketPrice",()=>setMarketPrice],["getExchangeMarkets",()=>getExchangeMarkets],["connectDb",()=>connectDb]]);let Database,aql;_ef3‍.w("arangojs",[["Database",["Database"],function(v){Database=v}],["aql",["aql"],function(v){aql=v}]]);// import {getNodetypes} from '../common/utils.js'
...
async function updateCollections(){
    ...
    _ef3‍.g.console.log('>>>>>>',edgeDescription)
    ...
    const nodeData = {price}
    const cursor = await db.query(aql`
    FOR market IN markets FILTER market.label == ${market.label}
    UPDATE market WITH {price: 45} IN  ${db.edgeCollection('markets')}
    return market
    `);
    _ef3‍.g.console.log(cursor.next())
}
