"main";_ada‍.x([["bittrex",()=>bittrex]]);let axios;_ada‍.w("axios",[["default",["axios"],function(v){axios=v}]]);let Market;_ada‍.w("../markets.js",[["Market",["Market"],function(v){Market=v}]]);let inspect;_ada‍.w("util",[["inspect",["inspect"],function(v){inspect=v}]]);
...
const bittrex = {
    ...
    async fetchMarkets(){
        ...
        _ada‍.g.console.log(inspect(apiResult.data.result))
        return
        fs.writeFile("./bittrex.json", )
