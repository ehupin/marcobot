"main";_3eb‍.x([["bittrex",()=>bittrex]]);let axios;_3eb‍.w("axios",[["default",["axios"],function(v){axios=v}]]);let Market;_3eb‍.w("../markets.js",[["Market",["Market"],function(v){Market=v}]]);let inspect;_3eb‍.w("util",[["inspect",["inspect"],function(v){inspect=v}]]);
...
const bittrex = {
    ...
    async fetchMarkets(){
        ...
        // console.log(inspect(apiResult.data.result))
        // return
        // fs.writeFile("./bittrex.json", JSON.stringify(apiResult.data.result, null, 4), ()=>{})
        // return
...
bittrex.fetchMarkets().then(markets=>{
    for (let market of markets){
        if (market.baseCurrency == 'xem' || market.quoteCurrency == 'xem'){
                        _3eb‍.g.console.log(market)
                    }
    }
})
