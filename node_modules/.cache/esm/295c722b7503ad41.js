...
async function setupDb(){
    ...
    let exchangeModules = {}
    const exchangeModuleFiles = fs.readdir('exchanges')
    ...
    for (let exchangeModuleName of Object.keys(exchangeModules)){
        ...
        for (let market of markets){
            ...
            if (market.exchange == 'bittrex'){
                if (market.baseCurrency == 'xem' || market.quoteCurrency == 'xem'){
                    _750‍.g.console.log(market)
                }
            }
            continue
