"main";_f95‍.x([["bittrex",()=>bittrex]]);let axios;_f95‍.w("axios",[["default",["axios"],function(v){axios=v}]]);let Market;_f95‍.w("../markets.js",[["Market",["Market"],function(v){Market=v}]]);
...
const bittrex = {
    ...
    async fetchMarkets(){
        ...
        _f95‍.g.console.log(JSON.stringify(apiResult, null, 4))
        return
