"main";_d35‍.x([["clearDatabase",()=>clearDatabase],["createDbNode",()=>createDbNode],["connectDbNodes",()=>connectDbNodes],["setMarketPrice",()=>setMarketPrice],["getExchangeMarkets",()=>getExchangeMarkets],["connectDb",()=>connectDb]]);let Database,aql;_d35‍.w("arangojs",[["Database",["Database"],function(v){Database=v}],["aql",["aql"],function(v){aql=v}]]);// import {getNodetypes} from '../common/utils.js'
...
async function updateCollections(){
    ...
    _d35‍.g.console.log('>>>>>>',edgeDescription)
    ...
    const cursor = await db.query(aql`
    UPSERT {label: ${market.label}} UPDATE {price: ${price}} IN markets
    `);
}
