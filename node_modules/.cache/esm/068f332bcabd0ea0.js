"main";_cab‍.x([["clearDatabase",()=>clearDatabase],["createDbNode",()=>createDbNode],["connectDbNodes",()=>connectDbNodes],["setMarketPrice",()=>setMarketPrice],["getExchangeMarkets",()=>getExchangeMarkets],["connectDb",()=>connectDb]]);let Database,aql;_cab‍.w("arangojs",[["Database",["Database"],function(v){Database=v}],["aql",["aql"],function(v){aql=v}]]);// import {getNodetypes} from '../common/utils.js'
...
async function updateCollections(){
    ...
    _cab‍.g.console.log('>>>>>>',edgeDescription)
    ...
    UPDATE market WITH ${nodeData} IN markets
    return market
    `);
    _cab‍.g.console.log(cursor.next())
}
