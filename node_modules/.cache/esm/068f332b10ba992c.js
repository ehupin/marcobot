"main";_10b‍.x([["clearDatabase",()=>clearDatabase],["createDbNode",()=>createDbNode],["connectDbNodes",()=>connectDbNodes],["setMarketPrice",()=>setMarketPrice],["getExchangeMarkets",()=>getExchangeMarkets],["connectDb",()=>connectDb]]);let Database,aql;_10b‍.w("arangojs",[["Database",["Database"],function(v){Database=v}],["aql",["aql"],function(v){aql=v}]]);// import {getNodetypes} from '../common/utils.js'
...
async function updateCollections(){
    ...
    _10b‍.g.console.log('>>>>>>',edgeDescription)
    ...
    UPDATE market WITH {price: ${price}} IN  ${db.edgeCollection('markets')}
    return market
    `);
    _10b‍.g.console.log(cursor.next())
}
