    ...
    fs.readdir('exchanges', async (err,moduleFiles)=>{
        ...
        for (let exchangeModuleName of Object.keys(exchangeModules)){
            ...
            for (let market of markets){
                ...
                tempEdgeTree.add('marketHasExchange', marketNode, exchange)
                tempEdgeTree.add('marketHasBaseCurrency', marketNode, baseCurrency)
                tempEdgeTree.add('marketHasQuoteCurrency', marketNode, quoteCurrency)
                tempEdgeTree.add('exchangeHasCurrency', exchange, baseCurrency)
                tempEdgeTree.add('exchangeHasCurrency', exchange, quoteCurrency)
                return
            }
            // tempEdgeTree.out()
            // edgeTree.build()
