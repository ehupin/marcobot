"main";_3b2‍.x([["clearDatabase",()=>clearDatabase],["createDbNode",()=>createDbNode],["connectDbNodes",()=>connectDbNodes],["setMarketPrice",()=>setMarketPrice],["getExchangeMarkets",()=>getExchangeMarkets],["connectDb",()=>connectDb]]);let Database,aql;_3b2‍.w("arangojs",[["Database",["Database"],function(v){Database=v}],["aql",["aql"],function(v){aql=v}]]);// import {getNodetypes} from '../common/utils.js'
...
async function updateCollections(){
    ...
    _3b2‍.g.console.log('>>>>>>',edgeDescription)
    ...
    UPDATE market WITH {price: 5} IN markets
    return market
    `);
    _3b2‍.g.console.log(cursor.next())
}
