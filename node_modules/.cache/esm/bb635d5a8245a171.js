...
async function updateDb(){
    ...
    for (let exchangeName of Object.keys(exchangeModules)){
        ...
        _824‍.g.console.log('==========================',exchangeName)
...
request('https://exchangebit.info/bittrex', function(err, resp, html) {
        if (!err){
          ...
          let i = 0
          $(`html body main.container table.table.table-striped.border.table-sm tbody`).each((i,e)=>{
              
              
            _824‍.g.console.log(e.name)
              $(e).each((o,x)=>{
                  _824‍.g.console.log(x.name)
              })
             _824‍.g.console.log('=====')
          })
