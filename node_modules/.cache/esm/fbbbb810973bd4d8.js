"main";_973‍.x([["bittrex",()=>bittrex]]);let axios;_973‍.w("axios",[["default",["axios"],function(v){axios=v}]]);let Market;_973‍.w("../markets.js",[["Market",["Market"],function(v){Market=v}]]);let inspect;_973‍.w("util",[["inspect",["inspect"],function(v){inspect=v}]]);
...
const bittrex = {
    ...
    async fetchMarkets(){
        ...
        _973‍.g.console.log(inspect(apiResult.data))
        return
